<?php
    ...
    echo "<table border='1'>";
    echo "<tr><th> Id </th><th> Nome </th><th> Idade </th><th> E-mail </th><th> Data </th><th> Atualizar </th></tr>"; // Cabeçalho da tabela
    ...
    foreach ($dados as $info){
        ...
        echo "<td><a href=formEdit.php?id=".$info['id']."> Editar </a></td>";
        echo "<tr>";
    }
    echo "</table>";
